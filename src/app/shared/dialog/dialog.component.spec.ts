...
describe('DialogComponent', () => {
    ...
    describe('Initialization', () => {
        ...
        it('should display title and message from data', () => {
            ...
            expect(compiled.querySelector('.dialog-header')?.textContent).toContain('Поздравляем!');
            expect(compiled.querySelector('.dialog-message')?.textContent).toContain('Задание выполнено');
        });
    });
