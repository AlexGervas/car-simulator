...
describe('StartPageComponent', () => {
    ...
    beforeEach(waitForAsync(() => {
        ...
        mockLevelService = jasmine.createSpyObj('LevelService', ['isLevelAvailable'], {
            levels$: levels$,
    ...
    describe('initialization', () => {
        ...
        it('should generate level buttons with correct availability and icons', () => {
            ...
            const parkingBtn = component.levelBtns.find(btn => btn.name === 'parallel-parking');
            const garageBtn = component.levelBtns.find(btn => btn.name === 'garage');
