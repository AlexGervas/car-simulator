...
describe('SimulatorComponent', () => {
  ...
  const mockAuthService = {
    loginWithTelegram: jasmine
      .createSpy('loginWithTelegram')
      .and.returnValue(of({ token: 'mockToken', user: {} })),
    setUser: jasmine.createSpy('setUser'),
    getToken: jasmine.createSpy('getToken').and.returnValue('mockToken'),
  };

  const mockUserService = {
    loadUserFromApi: jasmine
      .createSpy('loadUserFromApi')
      .and.returnValue(of({})),
  ...
  describe('clearLevelScene', () => {
    it('should call removeCones, clearConeStates, and removeStopLine', fakeAsync(() => {
      component.trafficCones = jasmine.createSpyObj('TrafficConesComponent', [
        'removeCones',
      ]);
  ...
  describe('initSteepGradeScene', () => {
    ...
    beforeEach(() => {
      ...
      bridgeComponentRefMock = {
        instance: {
          createBridge: jasmine
            .createSpy('createBridge')
      ...
      component.dynamicComponents = jasmine.createSpyObj('ViewContainerRef', [
        'createComponent',
      ]);
      (
        component.dynamicComponents.createComponent as jasmine.Spy
      ).and.returnValue(bridgeComponentRefMock);
  ...
  describe('Game control methods', () => {
    ...
    describe('resetGameState', () => {
      beforeEach(() => {
        ...
        component.coneStateService = jasmine.createSpyObj('ConeStateService', [
          'resetConeState',
        ]);
    ...
    describe('goToNextLevel', () => {
      ...
      it('should go to the next level if available', fakeAsync(() => {
        ...
        component.levelService = jasmine.createSpyObj('LevelService', [
          'getNextLevel',
  ...
  describe('checkCollisionWithCones', () => {
    ...
    beforeEach(() => {
      ...
      mockTrafficCones = {
        ...
        getInitialConePositions: jasmine
          .createSpy('getInitialConePositions')
          .and.returnValue([new CANNON.Vec3(0, 0, 0)]),
      };
  ...
  describe('handleSnakeLevelGameOver', () => {
    ...
    beforeEach(() => {
      ...
      mockApi = {
        completeLevel: jasmine
          .createSpy('completeLevel')
      ...
      (component as any).levelService = {
        loadLevels: jasmine
          .createSpy('loadLevels')
          .and.returnValue(Promise.resolve()),
        isNextLevelAvailable: jasmine
          .createSpy('isNextLevelAvailable')
          .and.returnValue(true),
      };
  ...
  describe('handleParkingLevelGameOver', () => {
    beforeEach(() => {
      ...
      (component as any).shouldShowCheckDialog = jasmine
        .createSpy('shouldShowCheckDialog')
        .and.returnValue(true);
  ...
  describe('shouldShowCheckDialog', () => {
    beforeEach(() => {
      (component as any).trafficCones = {
        checkCarInsideParkingPocket: jasmine
          .createSpy('checkCarInsideParkingPocket')
    ...
    it('should return true if preciseMatch = true', () => {
      (
        component as any
      ).trafficCones.checkCarInsideParkingPocket.and.returnValue({
        preciseMatch: true,
        nearMatch: false,
      });
  ...
  describe('showCheckDialog', () => {
    ...
    beforeEach(() => {
      ...
      (component as any).dialogService = {
        openDialogWithRef: jasmine
          .createSpy('openDialogWithRef')
          .and.returnValue({
      ...
      (component as any).startParkingCheck =
        jasmine.createSpy('startParkingCheck');
    });
  ...
  describe('startParkingCheck', () => {
    beforeEach(() => {
      ...
      (component as any).ensureUser$ = jasmine
        .createSpy('ensureUser$')
        .and.returnValue(of({ userId: 123 }));
    });
  ...
  describe('createStopLine', () => {
    beforeEach(() => {
      (component as any).trafficCones = {
        getConeBoxes: jasmine
          .createSpy('getConeBoxes')
          .and.returnValue([{ max: { z: 10 } }]),
      };
      (component as any).stopLineComponent = {
        createStopLine: jasmine
          .createSpy('createStopLine')
          .and.returnValue(Promise.resolve()),
      };
    });
