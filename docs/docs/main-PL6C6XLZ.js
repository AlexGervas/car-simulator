...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:or,depthTest:!1,depthWrite:!1})}function HS(){return new fi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:jg(),fragmentShader:`
		...
		`,blending:or,depthTest:!1,depthWrite:!1})}function zS(){return new fi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:jg(),fragmentShader:`
		...
		`,blending:or,depthTest:!1,depthWrite:!1})}function jg(){return`
